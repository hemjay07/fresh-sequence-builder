...
export default function SchedulePicker() {
  ...
  useEffect(() => {
    ...
    dispatch({ type: 'SET_CAN_PROGRESS', payload: validated.every(s => s.status !== 'invalid') });
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8 mb-8 shadow-sm">
        ...
        <div className="relative py-8">
          <div className="relative flex justify-between items-center">
            {/* Timeline Line */}
            <div className="absolute top-7 left-0 right-0 h-1 bg-gradient-to-r from-blue-200 via-indigo-200 to-blue-200 rounded-full" style={{ 
